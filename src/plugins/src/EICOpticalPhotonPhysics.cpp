 ...
 *
 * @{
 * \package Geant4OpticalPhotonPhysics
 *
...
namespace dd4hep {
  ...
  namespace sim {
     ...
     */
    class EICOpticalPhotonPhysics : public Geant4PhysicsList    {
    public:
      /// Default constructor
      EICOpticalPhotonPhysics() = delete;
      /// Copy constructor
      EICOpticalPhotonPhysics(const EICOpticalPhotonPhysics&) = delete;
      /// Initializing constructor
      EICOpticalPhotonPhysics(Geant4Context* ctxt, const std::string& nam)
        : Geant4PhysicsList(ctxt, nam)
      {
        declareProperty("VerboseLevel", m_verbosity = 0);
      }
      /// Default destructor
      virtual ~EICOpticalPhotonPhysics() = default;
...
DECLARE_GEANT4ACTION(EICOpticalPhotonPhysics)
