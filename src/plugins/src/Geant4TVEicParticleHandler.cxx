...
namespace npdet::sim {
  ...
  /**
   *  EIC version of Geant4TVUserParticleHandler. TV stands for TrackingVolume.
  ...
  class Geant4TVEicParticleHandler : public dd4hep::sim::Geant4UserParticleHandler {
    ...
    /// EIC forward/backward low-momentum rejection cuts (configurable properties).
    /// Particles ending at Z > m_zMax with |p| < m_pMin are dropped.
    double m_forwardZ{335 * dd4hep::cm};    ///< Forward region Z (and goes in positive direction)
    double m_backwardZ{-175 * dd4hep::cm};  ///< Backward region Z (and goes in negative direction)
    double m_forwardMomentumMin{100 * dd4hep::MeV};   ///< momentum threshold for forward area
    double m_backwardMomentumMin{100 * dd4hep::MeV};   ///< momentum magnitude for backward area
