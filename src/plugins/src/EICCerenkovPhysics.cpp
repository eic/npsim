...
namespace dd4hep {
  ...
  namespace sim {
     ...
     */
    class EICCerenkovPhysics : public Geant4PhysicsList    {
    public:
      /// Default constructor
      EICCerenkovPhysics() = delete;
      /// Copy constructor
      EICCerenkovPhysics(const EICCerenkovPhysics&) = delete;
      /// Initializing constructor
      EICCerenkovPhysics(Geant4Context* ctxt, const std::string& nam)
      ...
      /// Default destructor
      virtual ~EICCerenkovPhysics() = default;
...
DECLARE_GEANT4ACTION(EICCerenkovPhysics)
