...
namespace dd4hep {
  ...
  namespace sim {
     ...
     */
    class EICScintillationPhysics : public Geant4PhysicsList    {
    public:
      /// Default constructor
      EICScintillationPhysics() = delete;
      /// Copy constructor
      EICScintillationPhysics(const EICScintillationPhysics&) = delete;
      /// Initializing constructor
      EICScintillationPhysics(Geant4Context* ctxt, const std::string& nam)
      ...
      /// Default destructor
      virtual ~EICScintillationPhysics() = default;
...
DECLARE_GEANT4ACTION(EICScintillationPhysics)
