...
SIM.part.userParticleHandlerOptions = {
    "ForwardRegionZ":       5000 * mm,    # +Z dead-zone boundary
    "BackwardRegionZ":     -5000 * mm,    # -Z dead-zone boundary
...
|------------------------|--------|-------------|----------|----------------------------------------------------------------------|
| `ForwardRegionZ`       | double | `5000 * mm` | length   | Particles ending at Z above this are subject to the forward cut      |
| `BackwardRegionZ`      | double | `5000 * mm` | length   | Particles ending at Z below `-BackwardRegionZ` are subject to the backward cut |
