...
void TGeoToStep::CreateGeometry(const char* fname, int max_level, double length_unit_to_mm)
{
   //ROOT CAD CONVERSION
   fCreate = new TOCCToStep();
   fCreate->OCCShapeCreation(fGeometry, length_unit_to_mm);
...
void TGeoToStep::CreatePartialGeometry(const char* part_name, int max_level, const char* fname, double length_unit_to_mm)
{
   //ROOT CAD CONVERSION
   fCreate = new TOCCToStep();
   fCreate->OCCShapeCreation(fGeometry, length_unit_to_mm);
...
void TGeoToStep::CreatePartialGeometry(std::map<std::string,int> part_name_levels, const char* fname, double length_unit_to_mm)
{
  //ROOT CAD CONVERSION
  fCreate = new TOCCToStep();
  fCreate->OCCShapeCreation(fGeometry, length_unit_to_mm);
